...
__VLS_asFunctionalElement1(__VLS_intrinsics.aside, __VLS_intrinsics.aside)({
    ...
    ...{ class: ([
            __VLS_ctx.sidebarOpen ? 'w-64' : 'w-16',
            __VLS_ctx.mobileMenuOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0',
        ]) },
...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...{ class: "flex items-center h-16 px-4 border-b border-gray-100 dark:border-gray-700 gap-3 min-w-0" },
});
/** @type {__VLS_StyleScopedClasses['flex']} */ ;
...
__VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
    ...{ onClick: (...[$event]) => {
            ...
            // @ts-ignore
            [mobileMenuOpen, sidebarOpen, sidebarOpen, sidebarOpen, sidebarOpen, firmStore, firmStore, firmStore, firmStore, firmStore,];
        } },
...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...{ class: "border-t border-gray-100 dark:border-gray-700 p-3" },
});
...
__VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
    ...{ onClick: (...[$event]) => {
            ...
            // @ts-ignore
            [mobileMenuOpen, mobileMenuOpen, sidebarOpen, sidebarOpen, sidebarOpen, sidebarOpen, toggleDark, isDark, isDark, isDark, isDark, userInitials, authStore, authStore, signOut, signOut,];
        } },
...
__VLS_asFunctionalElement1(__VLS_intrinsics.h1, __VLS_intrinsics.h1)({
    ...{ class: "text-base font-semibold text-gray-900 dark:text-gray-100 flex-shrink-0" },
});
/** @type {__VLS_StyleScopedClasses['text-base']} */ ;
/** @type {__VLS_StyleScopedClasses['font-semibold']} */ ;
/** @type {__VLS_StyleScopedClasses['text-gray-900']} */ ;
...
__VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({
    ...{ class: "text-sm text-gray-400 dark:text-gray-500 flex-1" },
});
/** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
/** @type {__VLS_StyleScopedClasses['text-gray-400']} */ ;
/** @type {__VLS_StyleScopedClasses['dark:text-gray-500']} */ ;
...
if (__VLS_ctx.notifOpen) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
        ...{ onClick: (...[$event]) => {
                ...
                // @ts-ignore
                [toggleNotifPanel, notifOpen, notifOpen, notifOpen, notifStore, notifStore, notifStore,];
            } },
    ...
    if (__VLS_ctx.notifStore.loading) {
        ...
        for (const [n] of __VLS_vFor((__VLS_ctx.notifStore.notifications))) {
            ...
            /** @type {__VLS_StyleScopedClasses['flex-1']} */ ;
            __VLS_asFunctionalElement1(__VLS_intrinsics.p, __VLS_intrinsics.p)({
                ...{ class: "text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-0.5" },
            });
            /** @type {__VLS_StyleScopedClasses['text-xs']} */ ;
            /** @type {__VLS_StyleScopedClasses['font-medium']} */ ;
            /** @type {__VLS_StyleScopedClasses['text-gray-500']} */ ;
            ...
            __VLS_asFunctionalElement1(__VLS_intrinsics.p, __VLS_intrinsics.p)({
                ...{ class: "text-sm text-gray-900 dark:text-gray-100 leading-snug truncate" },
            });
            /** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
            /** @type {__VLS_StyleScopedClasses['text-gray-900']} */ ;
            /** @type {__VLS_StyleScopedClasses['dark:text-gray-100']} */ ;
        ...
        for (const [firm] of __VLS_vFor((__VLS_ctx.firmStore.firms))) {
            __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
                ...{ onClick: (...[$event]) => {
                        ...
                        // @ts-ignore
                        [firmStore, firmStore, firmStore, toggleFirmSwitcher, firmSwitcherOpen, firmSwitcherOpen, switchFirm,];
                    } },
                key: (firm.id),
...
if (__VLS_ctx.shortcutHelpOpen) {
    ...
    for (const [sc] of __VLS_vFor((__VLS_ctx.SHORTCUTS))) {
        ...
        (sc.description);
        __VLS_asFunctionalElement1(__VLS_intrinsics.kbd, __VLS_intrinsics.kbd)({
            ...{ class: "inline-flex items-center gap-1 px-2 py-1 rounded bg-gray-100 dark:bg-gray-700 text-xs font-mono text-gray-700 dark:text-gray-300" },
        });
