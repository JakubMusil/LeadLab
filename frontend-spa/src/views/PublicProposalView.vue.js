...
if (__VLS_ctx.loading) {
    ...
    /** @type {__VLS_StyleScopedClasses['min-h-screen']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
        ...{ class: "animate-pulse space-y-4 w-full max-w-2xl mx-auto p-8" },
    });
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.div)({
        ...{ class: "h-64 bg-gray-100 rounded-2xl" },
    });
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
        ...
        ...{ style: ({ borderTopColor: __VLS_ctx.proposal.firm_primary_color, borderTopWidth: '4px' }) },
    });
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
        ...{ class: "flex flex-wrap gap-4 mt-4 text-xs text-gray-400" },
    });
    /** @type {__VLS_StyleScopedClasses['flex']} */ ;
    /** @type {__VLS_StyleScopedClasses['flex-wrap']} */ ;
    /** @type {__VLS_StyleScopedClasses['gap-4']} */ ;
    ...
    if (__VLS_ctx.proposal.items.length === 0) {
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.th, __VLS_intrinsics.th)({
            ...{ class: "text-left px-4 py-2.5 rounded-tl-xl" },
        });
        ...
        /** @type {__VLS_StyleScopedClasses['py-2.5']} */ ;
        __VLS_asFunctionalElement1(__VLS_intrinsics.th, __VLS_intrinsics.th)({
            ...{ class: "text-right px-4 py-2.5 rounded-tr-xl" },
        });
        /** @type {__VLS_StyleScopedClasses['text-right']} */ ;
        /** @type {__VLS_StyleScopedClasses['px-4']} */ ;
        /** @type {__VLS_StyleScopedClasses['py-2.5']} */ ;
        ...
        for (const [item] of __VLS_vFor((__VLS_ctx.proposal.items))) {
            ...
            (item.description);
            __VLS_asFunctionalElement1(__VLS_intrinsics.td, __VLS_intrinsics.td)({
                ...{ class: "px-3 py-3 text-right text-gray-500" },
            });
            /** @type {__VLS_StyleScopedClasses['px-3']} */ ;
            /** @type {__VLS_StyleScopedClasses['py-3']} */ ;
            /** @type {__VLS_StyleScopedClasses['text-right']} */ ;
    ...
    /** @type {__VLS_StyleScopedClasses['justify-end']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
        ...{ class: "min-w-56 text-sm space-y-1" },
    });
    ...
    if (__VLS_ctx.proposal.closing_text) {
        ...
        /** @type {__VLS_StyleScopedClasses['mb-6']} */ ;
        __VLS_asFunctionalElement1(__VLS_intrinsics.p, __VLS_intrinsics.p)({
            ...{ class: "text-gray-600 leading-relaxed whitespace-pre-wrap text-sm" },
        });
        /** @type {__VLS_StyleScopedClasses['text-gray-600']} */ ;
        /** @type {__VLS_StyleScopedClasses['leading-relaxed']} */ ;
        /** @type {__VLS_StyleScopedClasses['whitespace-pre-wrap']} */ ;
    ...
    if (!__VLS_ctx.proposal.is_expired && __VLS_ctx.proposal.status !== 'accepted' && __VLS_ctx.proposal.status !== 'rejected') {
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
            ...{ onClick: (...[$event]) => {
                    ...
                    // @ts-ignore
                    [proposal, proposal, proposal, proposal, proposal, proposal, proposal, proposal, proposal, proposal, proposal, fmt, fmt, fmt, fmt, subtotal, discountTotal, discountTotal, taxTotal, taxTotal, respond,];
                } },
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
            ...{ onClick: (...[$event]) => {
                    ...
                    // @ts-ignore
                    [respond, responding, responding, responseAction,];
                } },
    ...
    if (__VLS_ctx.proposal.is_expired) {
        __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
            ...{ class: "rounded-2xl bg-orange-50 border border-orange-200 p-4 text-center text-sm text-orange-700" },
        });
        /** @type {__VLS_StyleScopedClasses['rounded-2xl']} */ ;
