...
if (__VLS_ctx.store.loading && __VLS_ctx.store.customers.length === 0) {
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.th, __VLS_intrinsics.th)({
        ...{ class: "px-4 py-3 text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide hidden sm:table-cell" },
    });
    /** @type {__VLS_StyleScopedClasses['px-4']} */ ;
    /** @type {__VLS_StyleScopedClasses['py-3']} */ ;
    /** @type {__VLS_StyleScopedClasses['text-xs']} */ ;
    ...
    for (const [c] of __VLS_vFor((__VLS_ctx.store.customers))) {
        __VLS_asFunctionalElement1(__VLS_intrinsics.tr, __VLS_intrinsics.tr)({
            ...{ onClick: (...[$event]) => {
                    if (!!(__VLS_ctx.store.loading && __VLS_ctx.store.customers.length === 0))
                        return;
                    if (!!(__VLS_ctx.store.customers.length === 0))
                        return;
                    __VLS_ctx.goToDetail(c.id);
                    // @ts-ignore
                    [searchInput, searchInput, searchInput, openCreate, store, store, goToDetail,];
                } },
            ...{ onContextmenu: (...[$event]) => {
                    if (!!(__VLS_ctx.store.loading && __VLS_ctx.store.customers.length === 0))
                        return;
...
if (__VLS_ctx.showModal) {
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
        ...{ onClick: (...[$event]) => {
                ...
                __VLS_ctx.showModal = false;
                // @ts-ignore
                [showModal, editingCustomer, editingCustomer, formError, formError, submitForm, formFirstName, formLastName, formEmail, formPhone, formCompany, formTagsInput,];
            } },
        type: "button",
