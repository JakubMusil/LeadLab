...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...{ class: "p-6 max-w-4xl mx-auto space-y-5" },
});
...
if (__VLS_ctx.store.loadingDetail) {
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.div)({
        ...{ class: "h-32 bg-gray-100 rounded-2xl" },
    });
    ...
    /** @type {__VLS_StyleScopedClasses['gap-4']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
        ...{ class: "w-14 h-14 rounded-2xl bg-red-100 flex items-center justify-center text-red-600 text-xl font-semibold flex-shrink-0" },
    });
    ...
    for (const [tag] of __VLS_vFor((__VLS_ctx.store.currentCustomer.tags))) {
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
            ...{ onClick: (...[$event]) => {
                    if (!!(__VLS_ctx.store.loadingDetail))
                        return;
                    if (!(__VLS_ctx.store.currentCustomer))
                        return;
                    __VLS_ctx.removeTag(tag);
                    // @ts-ignore
                    [store, store, store, store, store, store, store, store, store, store, store, store, store, store, editing, editing, editError, editError, editFirstName, editLastName, editEmail, editPhone, editCompany, saveEdit, editLoading, editLoading, cancelEdit, startEdit, removeTag,];
                } },
    ...
    if (Object.keys(__VLS_ctx.store.currentCustomer.metadata).length > 0) {
        __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
            ...{ class: "divide-y divide-gray-50 mb-3" },
        });
        ...
        for (const [val, key] of __VLS_vFor((__VLS_ctx.store.currentCustomer.metadata))) {
            ...
            __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({
                ...{ class: "text-sm font-medium text-gray-700 w-32 flex-shrink-0 truncate" },
            });
            /** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
            ...
            __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
                ...{ onClick: (...[$event]) => {
                        ...
                        // @ts-ignore
                        [store, store, store, tagsLoading, addTag, addTag, newTag, newTag, removeMetadata,];
                    } },
