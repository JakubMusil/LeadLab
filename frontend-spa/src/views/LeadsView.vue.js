    ...
    for (const [view] of __VLS_vFor((__VLS_ctx.savedViewsStore.viewsForEntity('leads')))) {
        __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
            ...{ onClick: (...[$event]) => {
                    ...
                    // @ts-ignore
                    [savedViewsStore, savedViewsStore, router,];
                } },
            key: (view.id),
...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...{ class: "flex rounded-xl border border-gray-200 dark:border-gray-600 overflow-hidden text-sm" },
});
/** @type {__VLS_StyleScopedClasses['flex']} */ ;
/** @type {__VLS_StyleScopedClasses['rounded-xl']} */ ;
/** @type {__VLS_StyleScopedClasses['border']} */ ;
...
if (__VLS_ctx.store.loading && __VLS_ctx.store.leads.length === 0) {
    ...
    if (__VLS_ctx.store.leads.length === 0) {
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.p, __VLS_intrinsics.p)({
            ...{ class: "text-sm text-gray-500 dark:text-gray-400 mb-6 max-w-xs" },
        });
        /** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.tr, __VLS_intrinsics.tr)({
            ...{ class: "border-b border-gray-100 dark:border-gray-700 text-left" },
        });
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.th, __VLS_intrinsics.th)({
            ...{ class: "px-4 py-3 text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide" },
        });
        /** @type {__VLS_StyleScopedClasses['px-4']} */ ;
        ...
        /** @type {__VLS_StyleScopedClasses['tracking-wide']} */ ;
        __VLS_asFunctionalElement1(__VLS_intrinsics.th, __VLS_intrinsics.th)({
            ...{ class: "px-4 py-3 text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide hidden md:table-cell" },
        });
        /** @type {__VLS_StyleScopedClasses['px-4']} */ ;
        /** @type {__VLS_StyleScopedClasses['py-3']} */ ;
        /** @type {__VLS_StyleScopedClasses['text-xs']} */ ;
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.th, __VLS_intrinsics.th)({
            ...{ class: "px-4 py-3 text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide hidden lg:table-cell" },
        });
        /** @type {__VLS_StyleScopedClasses['px-4']} */ ;
        /** @type {__VLS_StyleScopedClasses['py-3']} */ ;
        /** @type {__VLS_StyleScopedClasses['text-xs']} */ ;
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.th, __VLS_intrinsics.th)({
            ...{ class: "px-4 py-3 text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide hidden xl:table-cell" },
        });
        /** @type {__VLS_StyleScopedClasses['px-4']} */ ;
        /** @type {__VLS_StyleScopedClasses['py-3']} */ ;
        /** @type {__VLS_StyleScopedClasses['text-xs']} */ ;
        ...
        for (const [lead] of __VLS_vFor((__VLS_ctx.store.leads))) {
            __VLS_asFunctionalElement1(__VLS_intrinsics.tr, __VLS_intrinsics.tr)({
                ...{ onClick: (...[$event]) => {
                        ...
                        // @ts-ignore
                        [viewMode, filterStatus, filterStatus, filterSource, filterSource, openCreate, store, store, goToDetail,];
                    } },
                ...{ onContextmenu: (...[$event]) => {
                        if (!!(__VLS_ctx.store.loading && __VLS_ctx.store.leads.length === 0))
                            return;
            ...
            __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
                ...{ onClick: (...[$event]) => {
                        ...
                        // @ts-ignore
                        [overdueTasks, statusPopupId, statusPopupId,];
                    } },
                ...
                for (const [s] of __VLS_vFor((__VLS_ctx.LEAD_STATUSES))) {
                    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
                        ...{ onClick: (...[$event]) => {
                                ...
                                // @ts-ignore
                                [LEAD_STATUSES, statusPopupId, getStatusMeta, getStatusMeta, getStatusMeta, changeStatus,];
                            } },
                        key: (s.value),
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
            ...{ class: "flex justify-between items-center px-4 py-3 border-t border-gray-100 dark:border-gray-700" },
        });
        /** @type {__VLS_StyleScopedClasses['flex']} */ ;
        ...
        if (__VLS_ctx.store.page > 1) {
            __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
                ...{ onClick: (...[$event]) => {
                        ...
                        if (!(__VLS_ctx.store.page > 1))
                            return;
                        __VLS_ctx.store.fetchLeads({ status: __VLS_ctx.filterStatus, source: __VLS_ctx.filterSource, page: __VLS_ctx.store.page - 1 });
                        // @ts-ignore
                        [filterStatus, filterSource, store, store, store, store,];
                    } },
        ...
        if (__VLS_ctx.store.hasMore) {
            __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
                ...{ onClick: (...[$event]) => {
                        ...
                        __VLS_ctx.store.fetchLeads({ status: __VLS_ctx.filterStatus, source: __VLS_ctx.filterSource, page: __VLS_ctx.store.page + 1 });
                        // @ts-ignore
                        [filterStatus, filterSource, store, store, store,];
                    } },
                ...{ class: "px-3 py-1 text-xs rounded-lg border border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300" },
            });
            /** @type {__VLS_StyleScopedClasses['px-3']} */ ;
    ...
    for (const [s] of __VLS_vFor((__VLS_ctx.LEAD_STATUSES))) {
        ...
        (s.label);
        __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({
            ...{ class: "ml-auto bg-white/60 dark:bg-black/30 rounded px-1.5 py-0.5" },
        });
        ...
        for (const [lead] of __VLS_vFor((__VLS_ctx.leadsByStatus[s.value]))) {
            __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
                ...{ onDragstart: (...[$event]) => {
                        ...
                        // @ts-ignore
                        [dragOverStatus, dragOverStatus, leadsByStatus, leadsByStatus, onDragStart,];
                    } },
                ...{ onContextmenu: (...[$event]) => {
                        if (!!(__VLS_ctx.store.loading && __VLS_ctx.store.leads.length === 0))
                            return;
        ...
        if ((__VLS_ctx.leadsByStatus[s.value]?.length ?? 0) === 0) {
            __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
                ...{ class: "text-center text-xs text-gray-300 dark:text-gray-600 py-4" },
            });
            /** @type {__VLS_StyleScopedClasses['text-center']} */ ;
            /** @type {__VLS_StyleScopedClasses['text-xs']} */ ;
...
if (__VLS_ctx.showSaveViewDialog) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
        ...{ onClick: (...[$event]) => {
                ...
                // @ts-ignore
                [showSaveViewDialog, showSaveViewDialog, LEAD_CONTEXT_ITEMS, onContextAction,];
            } },
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
        ...{ onClick: (...[$event]) => {
                ...
                __VLS_ctx.showSaveViewDialog = false;
                // @ts-ignore
                [filterStatus, filterSource, showSaveViewDialog, saveViewName,];
            } },
        type: "button",
...
if (__VLS_ctx.showModal) {
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
        ...{ onClick: (...[$event]) => {
                ...
                __VLS_ctx.showModal = false;
                // @ts-ignore
                [showModal, formSource, formValue, formCurrency,];
            } },
        type: "button",
        ...{ class: "flex-1 rounded-xl border border-gray-200 dark:border-gray-600 py-2 text-sm text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700" },
    });
