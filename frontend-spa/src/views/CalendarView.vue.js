...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(({ class: 'grid grid-cols-2 lg:grid-cols-3 gap-4 mb-5' }));
...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(({ class: 'text-xs text-gray-500 dark:text-gray-400 mb-1' }));
...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(({ class: 'bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-4 col-span-2 lg:col-span-1' }));
/** @type {__VLS_StyleScopedClasses['bg-white']} */ ;
/** @type {__VLS_StyleScopedClasses['dark:bg-gray-800']} */ ;
/** @type {__VLS_StyleScopedClasses['rounded-2xl']} */ ;
/** @type {__VLS_StyleScopedClasses['border']} */ ;
...
if (__VLS_ctx.tasksStore.loading) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.div)(({ class: 'animate-pulse h-64 bg-gray-100 dark:bg-gray-700 rounded-xl' }));
...
if (__VLS_ctx.upcomingTasks.length > 0) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(({ class: 'mt-4 bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-4' }));
	...
	onClick: (...[$event]) => {
		if (!(__VLS_ctx.upcomingTasks.length > 0)) return;
	...
	'aria-hidden': 'true'
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)(({ class: 'text-sm text-gray-800 dark:text-gray-200 flex-1' }));
        /** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
...
if (__VLS_ctx.showNewTaskModal) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(({
	onClick: (...[$event]) => {
		if (!__VLS_ctx.showNewTaskModal) return;
