...
if (!__VLS_ctx.successMsg) {
    ...
    (__VLS_ctx.isLoading ? 'Resetting…' : 'Reset password');
}
// @ts-ignore
[successMsg, successMsg, successMsg, errorMsg, errorMsg, handleSubmit, newPassword, confirmPassword, isLoading, isLoading, isLoading,];
