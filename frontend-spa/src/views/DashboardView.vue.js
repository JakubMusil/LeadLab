...
if (__VLS_ctx.showSetupBanner) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(({ class: 'bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-2xl p-5 flex items-center justify-between gap-4' }));
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(({ class: 'text-sm font-semibold text-red-900 dark:text-red-100' }));
    /** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
    /** @type {__VLS_StyleScopedClasses['font-semibold']} */ ;
    /** @type {__VLS_StyleScopedClasses['text-red-900']} */ ;
    /** @type {__VLS_StyleScopedClasses['dark:text-red-100']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(({ class: 'text-xs text-red-700 dark:text-red-300 mt-0.5' }));
...
if (__VLS_ctx.showLayoutEditor) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(({ class: 'bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-5' }));
    /** @type {__VLS_StyleScopedClasses['bg-white']} */ ;
    /** @type {__VLS_StyleScopedClasses['dark:bg-gray-800']} */ ;
    /** @type {__VLS_StyleScopedClasses['rounded-2xl']} */ ;
    /** @type {__VLS_StyleScopedClasses['border']} */ ;
	...
	'aria-hidden': 'true'
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)(({
	onClick: (...[$event]) => {
		if (!__VLS_ctx.showLayoutEditor) return;
...
if (__VLS_ctx.loading && !__VLS_ctx.stats) {
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(({ class: 'grid grid-cols-2 lg:grid-cols-4 gap-4' }));
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(({ class: 'grid lg:grid-cols-3 gap-4' }));
    /** @type {__VLS_StyleScopedClasses['grid']} */ ;
    /** @type {__VLS_StyleScopedClasses['lg:grid-cols-3']} */ ;
    /** @type {__VLS_StyleScopedClasses['gap-4']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.div)(({ class: 'lg:col-span-2 h-64 bg-gray-200 dark:bg-gray-700 rounded-2xl' }));
    /** @type {__VLS_StyleScopedClasses['lg:col-span-2']} */ ;
    /** @type {__VLS_StyleScopedClasses['h-64']} */ ;
    /** @type {__VLS_StyleScopedClasses['bg-gray-200']} */ ;
    /** @type {__VLS_StyleScopedClasses['dark:bg-gray-700']} */ ;
    /** @type {__VLS_StyleScopedClasses['rounded-2xl']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.div)(({ class: 'h-64 bg-gray-200 dark:bg-gray-700 rounded-2xl' }));
    /** @type {__VLS_StyleScopedClasses['h-64']} */ ;
    /** @type {__VLS_StyleScopedClasses['bg-gray-200']} */ ;
    /** @type {__VLS_StyleScopedClasses['dark:bg-gray-700']} */ ;
    /** @type {__VLS_StyleScopedClasses['rounded-2xl']} */ ;
    ...
    for (const [widget] of __VLS_vFor((__VLS_ctx.visibleWidgets))) {
        ...
        if (widget.id === 'stat_cards') {
            ...
            /** @type {__VLS_StyleScopedClasses['dark:border-gray-700']} */ ;
            /** @type {__VLS_StyleScopedClasses['p-5']} */ ;
            __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(({ class: 'text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide' }));
            /** @type {__VLS_StyleScopedClasses['text-xs']} */ ;
            /** @type {__VLS_StyleScopedClasses['font-medium']} */ ;
            ...
            __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(({ class: 'text-3xl font-bold text-gray-900 dark:text-gray-100 mt-1' }));
            ...
            __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(({ class: 'text-xs text-gray-400 dark:text-gray-500 mt-1' }));
            /** @type {__VLS_StyleScopedClasses['text-xs']} */ ;
            /** @type {__VLS_StyleScopedClasses['text-gray-400']} */ ;
            ...
            /** @type {__VLS_StyleScopedClasses['uppercase']} */ ;
            /** @type {__VLS_StyleScopedClasses['tracking-wide']} */ ;
            __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(({ class: 'text-2xl font-bold text-gray-900 dark:text-gray-100 mt-1' }));
	...
	...{ class: __VLS_ctx.stats.total_tasks_overdue > 0 ? 'text-red-500' : 'text-gray-400 dark:text-gray-500' }
            ...
            if (__VLS_ctx.visibleWidgets.some((w) => w.id === 'pipeline_chart') && __VLS_ctx.visibleWidgets.some((w) => w.id === 'recent_activity') && widget.id === 'pipeline_chart') {
                __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(({ class: 'lg:col-span-2 bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-5' }));
                /** @type {__VLS_StyleScopedClasses['lg:col-span-2']} */ ;
                /** @type {__VLS_StyleScopedClasses['bg-white']} */ ;
                /** @type {__VLS_StyleScopedClasses['dark:bg-gray-800']} */ ;
                /** @type {__VLS_StyleScopedClasses['rounded-2xl']} */ ;
                ...
                /** @type {__VLS_StyleScopedClasses['dark:border-gray-700']} */ ;
                /** @type {__VLS_StyleScopedClasses['p-5']} */ ;
                __VLS_asFunctionalElement1(__VLS_intrinsics.h3, __VLS_intrinsics.h3)(({ class: 'text-sm font-semibold text-gray-900 dark:text-gray-100 mb-4' }));
                /** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
                /** @type {__VLS_StyleScopedClasses['font-semibold']} */ ;
                /** @type {__VLS_StyleScopedClasses['text-gray-900']} */ ;
                /** @type {__VLS_StyleScopedClasses['dark:text-gray-100']} */ ;
	...
	autoresize: true
                ...
                __VLS_asFunctionalElement1(__VLS_intrinsics.ul, __VLS_intrinsics.ul)(({ class: 'space-y-3 overflow-y-auto max-h-56' }));
	...
	'aria-hidden': 'true'
                    ...
                    __VLS_asFunctionalElement1(__VLS_intrinsics.p, __VLS_intrinsics.p)(({ class: 'text-xs text-gray-700 dark:text-gray-300 truncate' }));
                    /** @type {__VLS_StyleScopedClasses['text-xs']} */ ;
                    /** @type {__VLS_StyleScopedClasses['text-gray-700']} */ ;
                    /** @type {__VLS_StyleScopedClasses['dark:text-gray-300']} */ ;
	...
	class: 'font-medium hover:text-red-600'
                ...
                __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(({ class: 'lg:col-span-3 bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-5' }));
	...
	autoresize: true
                ...
                __VLS_asFunctionalElement1(__VLS_intrinsics.ul, __VLS_intrinsics.ul)(({ class: 'space-y-3' }));
                /** @type {__VLS_StyleScopedClasses['space-y-3']} */ ;
                for (const [act] of __VLS_vFor((__VLS_ctx.stats.recent_activities))) {
                    __VLS_asFunctionalElement1(__VLS_intrinsics.li, __VLS_intrinsics.li)(({
	key: act.id,
	...
	...{ style: { backgroundColor: __VLS_ctx.STATUS_COLORS[status] ?? '#6b7280' } }
                ...
                /** @type {__VLS_StyleScopedClasses['rounded-full']} */ ;
                __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)(({ class: 'text-sm text-gray-700 dark:text-gray-300' }));
                /** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
                /** @type {__VLS_StyleScopedClasses['text-gray-700']} */ ;
                /** @type {__VLS_StyleScopedClasses['dark:text-gray-300']} */ ;
                (__VLS_ctx.STATUS_LABELS[status] ?? status);
                __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)(({ class: 'text-sm font-semibold text-gray-900 dark:text-gray-100' }));
                /** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
                /** @type {__VLS_StyleScopedClasses['font-semibold']} */ ;
                /** @type {__VLS_StyleScopedClasses['text-gray-900']} */ ;
                /** @type {__VLS_StyleScopedClasses['dark:text-gray-100']} */ ;
