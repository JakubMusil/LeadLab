...
if (__VLS_ctx.store.loadingDetail) {
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.div)({
        ...{ class: "h-8 bg-gray-200 rounded w-64" },
    });
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
        ...{ class: "bg-white rounded-2xl border border-gray-100 p-5 mb-5" },
    });
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
        ...{ onClick: (...[$event]) => {
                if (!!(__VLS_ctx.store.loadingDetail))
                    return;
                if (!(__VLS_ctx.store.currentLead))
                    return;
                __VLS_ctx.statusPopupOpen = !__VLS_ctx.statusPopupOpen;
                // @ts-ignore
                [store, store, store, store, store, statusPopupOpen, statusPopupOpen,];
            } },
        ...
        for (const [s] of __VLS_vFor((__VLS_ctx.LEAD_STATUSES))) {
            __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
                ...{ onClick: (...[$event]) => {
                        ...
                        // @ts-ignore
                        [store, store, statusPopupOpen, getStatusMeta, getStatusMeta, LEAD_STATUSES, changeStatus,];
                    } },
                key: (s.value),
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
        ...{ class: "flex flex-wrap gap-4 mt-4 text-xs text-gray-500" },
    });
    /** @type {__VLS_StyleScopedClasses['flex']} */ ;
    /** @type {__VLS_StyleScopedClasses['flex-wrap']} */ ;
    /** @type {__VLS_StyleScopedClasses['gap-4']} */ ;
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
        ...{ class: "flex gap-1 mb-4 bg-gray-100 rounded-xl p-1 w-fit" },
    });
    /** @type {__VLS_StyleScopedClasses['flex']} */ ;
    /** @type {__VLS_StyleScopedClasses['gap-1']} */ ;
    /** @type {__VLS_StyleScopedClasses['mb-4']} */ ;
    ...
    for (const [tab] of __VLS_vFor(['overview', 'activities', 'tasks', 'files', 'proposals'])) {
        __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
            ...{ onClick: (...[$event]) => {
                    ...
                    // @ts-ignore
                    [store, store, store, store, store, openEdit, deleteLead, switchTab,];
                } },
            key: (tab),
    ...
    if (__VLS_ctx.activeTab === 'overview') {
        ...
        if (__VLS_ctx.activitiesLoading) {
            ...
            for (const [act] of __VLS_vFor((__VLS_ctx.activities))) {
                ...
                /** @type {__VLS_StyleScopedClasses['flex-wrap']} */ ;
                __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({
                    ...{ class: "text-xs font-semibold text-gray-700 capitalize" },
                });
                /** @type {__VLS_StyleScopedClasses['text-xs']} */ ;
                /** @type {__VLS_StyleScopedClasses['font-semibold']} */ ;
                /** @type {__VLS_StyleScopedClasses['text-gray-700']} */ ;
                ...
                if (act.content_text) {
                    __VLS_asFunctionalElement1(__VLS_intrinsics.p)({
                        ...{ class: "text-sm text-gray-700 dark:text-gray-300 mt-0.5 prose prose-sm dark:prose-invert max-w-none" },
                    });
        ...
        if (__VLS_ctx.activitiesHasMore) {
            __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
                ...{ onClick: (...[$event]) => {
                        ...
                        // @ts-ignore
                        [activitiesHasMore, loadActivities, activitiesPage,];
                    } },
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
            ...
            ...{ class: (__VLS_ctx.isDraggingOver
        ...
        if (__VLS_ctx.filesLoading) {
            ...
            __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
                ...{ class: "bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 divide-y divide-gray-50 dark:divide-gray-700" },
            });
            /** @type {__VLS_StyleScopedClasses['bg-white']} */ ;
            /** @type {__VLS_StyleScopedClasses['dark:bg-gray-800']} */ ;
            /** @type {__VLS_StyleScopedClasses['rounded-2xl']} */ ;
            ...
            for (const [file] of __VLS_vFor((__VLS_ctx.files))) {
                ...
                __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
                    ...{ class: "w-10 h-10 rounded-xl flex-shrink-0 overflow-hidden bg-gray-100 dark:bg-gray-700 flex items-center justify-center" },
                });
                /** @type {__VLS_StyleScopedClasses['w-10']} */ ;
                /** @type {__VLS_StyleScopedClasses['h-10']} */ ;
                /** @type {__VLS_StyleScopedClasses['rounded-xl']} */ ;
                ...
                __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
                    ...{ onClick: (...[$event]) => {
                            ...
                            // @ts-ignore
                            [files, files, fmtBytes, deleteFile,];
                        } },
...
if (__VLS_ctx.showEditModal) {
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
        ...{ onClick: (...[$event]) => {
                ...
                __VLS_ctx.showEditModal = false;
                // @ts-ignore
                [showEditModal, editSource, editValue, editCurrency,];
            } },
        type: "button",
