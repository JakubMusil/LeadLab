  ...
  <div class="min-h-screen flex">
    ...
    <div class="hidden lg:flex lg:w-1/2 bg-red-600 flex-col justify-center items-center p-12 text-white">
      <div class="max-w-md text-center">
        ...
        <p class="text-xl text-red-100">Start your free account today.</p>
        <p class="mt-4 text-red-200 text-sm">Join thousands of sales teams using LeadLab.</p>
      </div>
    </div>
    ...
    <div class="flex-1 flex flex-col justify-center items-center p-8 bg-gray-50">
      <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          ...
          <p class="text-gray-500 mb-6 text-sm">Get started with LeadLab</p>
        ...
        <p class="text-center mt-6 text-sm text-gray-600">
          ...
          <RouterLink to="/app/login" class="text-red-600 font-medium hover:text-red-700">Sign in</RouterLink>
        </p>
      </div>
    </div>
  </div>
