/**
 * First-party plugin: LinkedIn Enrichment (frontend, v2.4)
 */
...
registerPlugin({
  manifest: {
    ...
    version: '1.0.0',
    description:
      'Given a LinkedIn profile URL on a customer record, fetches public profile data (name, title, company, avatar) via a proxy API and updates the customer fields.',
