...
function scheduleReconnect(firmId) {
    clearReconnectTimer();
...
export function useWebSocket() {
    ...
    const stopWatch = watch(() => firmStore.activeFirm?.id, () => ensureConnected(), { immediate: true });
    onUnmounted(() => {
        stopWatch();
